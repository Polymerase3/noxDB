...
**📖 Documentation:** <https://polymerase3.github.io/noxdb/>

---

## What is this?

`noxdb` is the lab's MariaDB metadata database and the Python
...
```bash
python -c "import noxdb; print(noxdb.__name__, 'OK')"
```

If that prints `noxdb OK` you're done.
...
- The `[noxdb]` section is your database login. Ask an admin for
  values to fill in.
- The `[noxdb-ssh]` section is only needed when you're connecting
...
see the [Install page in the docs](https://polymerase3.github.io/noxdb/install/).

---

## Where to go next

- **[Quickstart](https://polymerase3.github.io/noxdb/quickstart/)** —
  end-to-end Python example.
- **[Schema](https://polymerase3.github.io/noxdb/schema/)** —
  the table layout and naming conventions.
- **[API reference](https://polymerase3.github.io/noxdb/reference/)** —
  every public function.
- **[CLI](https://polymerase3.github.io/noxdb/cli/)** —
